...
export default function InitialVerificationDashboard() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-slate-800 dark:text-slate-100">Verificare Inițială</h2>
        <p className="text-slate-500 dark:text-slate-400 mt-1">Gestionează intrările și distribuie către departamentul tehnic.</p>
      </div>
